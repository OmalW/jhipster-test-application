...
import { JhipsterTestApplicationCoreModule } from 'app/core';
...
import { JhipsterTestApplicationAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        JhipsterTestApplicationSharedModule.forRoot(),
        JhipsterTestApplicationCoreModule,
        JhipsterTestApplicationHomeModule,
        JhipsterTestApplicationAccountModule,
